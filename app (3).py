...
# ============================================
# Only two rate files exist for this version:
# both are Reducing Cover, Single Life.
# ============================================
FILE_MAP = {
    ("Reducing", "Single Life", "Home Loan"): "REDUCING- HL.xlsx",
    ("Reducing", "Single Life", "LAP"):       "REDUCING- LAP.xlsx",
}

# Fixed values — no dropdown needed since only these variants exist
cover_type = "Reducing"
...
# ============================================
# DROPDOWN — only Loan Type, since Cover Type (Reducing)
# and Life Type (Single Life) are fixed for these two files.
# ============================================
